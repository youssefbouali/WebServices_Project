...
export const API_BASE_URLS = {
  ...
  DEVICES: import.meta.env.VITE_DEVICES_API_URL || import.meta.env.VITE_DEVICES || "http://localhost:8000",
  APPOINTMENTS: (import.meta.env as any).VITE_APPOINTMENTS_API_URL || import.meta.env.VITE_APPOINTMENTS || "http://localhost:8082",
  TREATMENTS:
    import.meta.env.VITE_TREATMENTS_API_URL || import.meta.env.VITE_TREATMENTS ||
    "http://localhost:8002",
};
