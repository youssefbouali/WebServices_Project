    ...
    <div className="flex min-h-screen bg-[#F5F7FA]">
      ...
      <div className="flex-1 lg:ml-[250px]">
        <header className="h-20 bg-white border-b border-[#E2E8F0] flex items-center justify-between px-6 lg:px-10">
          <h1 className="text-[#1E293B] text-xl lg:text-[28px] font-bold">Mes Rendez-vous</h1>
          <p className="text-[#64748B] text-sm">{fullName}</p>
        </header>
        <div className="p-6 lg:p-10">
          <p className="text-[#64748B]">Liste et gestion des rendez-vous (à implémenter).</p>
        </div>
      </div>
    </div>
  );
