...
export default function PatientTreatmentTracking() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const treatmentsData = await getPatientTreatments(user.id);
  ...
  const handleValidateDose = async () => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : "Échec de validation de la prise";
      setError(message);
  ...
  const handleSendReminder = async () => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : "Échec de l'envoi du rappel";
      setError(message);
      toast({ title: "Erreur", description: message });
    } finally {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
                      ...
                      <div className="relative w-20 h-20">
                        <svg className="w-full h-full" viewBox="0 0 88 88">
                          ...
                          <circle
                            ...
                            strokeDashoffset={
                              CIRC *
                              (1 - computeProgress(currentTreatment) / 100)
                            }
              ...
              <div className="bg-white rounded-xl border-2 border-[#E2E8F0] p-6">
                      ...
                      <div className="flex-1 bg-white border border-[#E2E8F0] rounded-lg p-4">
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <p className="text-xs text-[#64748B] mt-1">
                              {t.frequence} •{" "}
                              {new Date(t.dateDebut).toLocaleString()} →{" "}
                              {new Date(t.dateFin).toLocaleString()}
                            </p>
                          </div>
                ...
                <Button
                  onClick={handleValidateDose}
                  disabled={isValidating || !currentTreatment}
                  className="w-full mt-6 bg-[#10B981] hover:bg-[#059669] text-white h-11"
                >
                ...
                <div className="space-y-3">
                  <div className="flex justify-end">
                    <Button
                      ...
                      disabled={isSendingReminder || !currentTreatment}
