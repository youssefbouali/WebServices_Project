  ...
  return (
    <div className="flex min-h-screen bg-[#F8FBFF]">
      ...
      <main className="flex-1 ml-0 lg:ml-[250px]">
        <header className="bg-white border-b border-gray-200 shadow-sm px-4 lg:px-8 py-4 lg:py-5">
        ...
        <div className="p-4 lg:p-6 space-y-6">
            ...
            <div className="flex items-center justify-between mb-6 flex-col sm:flex-row gap-4">
              ...
              <div className="flex items-center gap-2 lg:gap-3 w-full sm:w-auto">
                ...
                <button
                  onClick={loadData}
                  disabled={isLoading}
                  className="bg-blue-600 text-white px-3 lg:px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2 disabled:opacity-50 text-sm"
                >
                  <RefreshCw
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
            <div className="border-b border-gray-200 px-4 lg:px-6 py-4 flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <button className="text-gray-600 hover:text-gray-900 text-xs lg:text-sm">
                  Exporter
                </button>
                <button className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-xs lg:text-sm">
                  Actions groupées
                </button>
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="w-8 px-4 lg:px-6 py-4"></th>
